[Project homepage](https://github.com/peter88213/nv_epub) > Instructions for use
...
If [novelibre](https://github.com/peter88213/novelibre/) is installed, the setup script *setup.py* installs the *nv_epub* plugin in the *novelibre* plugin directory.
